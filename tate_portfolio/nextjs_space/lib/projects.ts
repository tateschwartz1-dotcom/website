...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "I love inventing original games using the classic materials. I've collected all of my greatest hits and put them in a packet, sorted by game type. (I left out the many, many, many duds.)\n\nDownload the packet ",
